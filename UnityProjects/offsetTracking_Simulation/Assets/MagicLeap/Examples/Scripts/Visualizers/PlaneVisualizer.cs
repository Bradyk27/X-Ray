...
namespace MagicLeap
{
    ...
    public class PlaneVisualizer : MonoBehaviour
    {
        ...
        private RenderType _renderType = RenderType.Texture;
        #endregion
        ...
        private void DrawPlanes(MLWorldPlane[] planes)
        {
            ...
            if(!drawPlanes)
            {
                int index2 = planes.Length > 0 ? planes.Length - 1 : 0;
                for (int i = index2; i < _planeCache.Count; ++i)
                {
        ...
        public void togglePlaneDrawing(bool input)
        {
            drawPlanes = input;
        }
        #endregion
