...
namespace MagicLeap
{
    ...
    public class CombinedImageTrackingVisualizerV2 : MonoBehaviour
    {
        ...
        private CombinedImageTrackingExampleV2.ViewMode _lastViewMode = CombinedImageTrackingExampleV2.ViewMode.All;
        #endregion
        ...
        public void UpdateViewMode(CombinedImageTrackingExampleV2.ViewMode viewMode)
        {
        ...
        private void RefreshViewMode()
        {
            ...
            {
                case CombinedImageTrackingExampleV2.ViewMode.All:
                    _axis.SetActive(_targetFound);
                    _trackingCube.SetActive(_targetFound);
                    _demo.SetActive(_targetFound);
                    break;
                case CombinedImageTrackingExampleV2.ViewMode.AxisOnly:
                    _axis.SetActive(_targetFound);
                    _trackingCube.SetActive(false);
                    _demo.SetActive(false);
                    break;
                case CombinedImageTrackingExampleV2.ViewMode.TrackingCubeOnly:
                    _axis.SetActive(false);
                    _trackingCube.SetActive(_targetFound);
                    _demo.SetActive(false);
                    break;
                case CombinedImageTrackingExampleV2.ViewMode.DemoOnly:
                    _axis.SetActive(false);
                    _trackingCube.SetActive(false);
                    _demo.SetActive(_targetFound);
                    break;
