...
namespace MagicLeap
{
    ...
    public class CombinedImageTrackingExampleV2 : MonoBehaviour
    {
        #region Public Enum
        ...
        private CombinedImageTrackingExampleV2 trackingScript;
        ...
        private CombinedImageTrackingVisualizerV2[] _visualizers = null;
        ...
        void Awake()
        {
            ...
            trackingScript = trackingObject.GetComponent<CombinedImageTrackingExampleV2>();
        ...
        {
            foreach (CombinedImageTrackingVisualizerV2 visualizer in _visualizers)
            {
