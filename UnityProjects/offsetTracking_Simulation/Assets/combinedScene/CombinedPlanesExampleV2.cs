...
namespace MagicLeap
{
    ...
    public class CombinedPlanesExampleV2 : MonoBehaviour
    {
        ...
        private CombinedImageTrackingExample trackingScript;

        private static readonly Vector3 _boundedExtentsSize = new Vector3(10.0f, 10.0f, 10.0f);
        // Distance close to sensor's maximum recognition distance.
        private static readonly Vector3 _boundlessExtentsSize = new Vector3(15.0f, 15.0f, 15.0f);
        ...
        void Start()
        {
            trackingObject = GameObject.Find("ImageTrackingExample");
            trackingScript = trackingObject.GetComponent<CombinedImageTrackingExample>();
            UpdateBounds();
        }
        ...
        private void OnTriggerDown(byte controllerId, float triggerValue)
        {
            ...
            {
                trackingScript.displayTrackedItem();
