...
namespace MagicLeap
{
    ...
    public class CombinedImageTrackingVisualizer : MonoBehaviour
    {
        ...
        private CombinedImageTrackingExample.ViewMode _lastViewMode = CombinedImageTrackingExample.ViewMode.All;
        #endregion
        ...
        public void UpdateViewMode(CombinedImageTrackingExample.ViewMode viewMode)
        {
        ...
        private void RefreshViewMode()
        {
            ...
            {
                case CombinedImageTrackingExample.ViewMode.All:
                    _axis.SetActive(_targetFound);
                    _trackingCube.SetActive(_targetFound);
                    _demo.SetActive(_targetFound);
                    break;
                case CombinedImageTrackingExample.ViewMode.AxisOnly:
                    _axis.SetActive(_targetFound);
                    _trackingCube.SetActive(false);
                    _demo.SetActive(false);
                    break;
                case CombinedImageTrackingExample.ViewMode.TrackingCubeOnly:
                    _axis.SetActive(false);
                    _trackingCube.SetActive(_targetFound);
                    _demo.SetActive(false);
                    break;
                case CombinedImageTrackingExample.ViewMode.DemoOnly:
                    _axis.SetActive(false);
                    _trackingCube.SetActive(false);
                    _demo.SetActive(_targetFound);
                    break;
                case CombinedImageTrackingExample.ViewMode.None:
                    _axis.SetActive(false);
                    _trackingCube.SetActive(false);
                    _demo.SetActive(false);
                    break;
